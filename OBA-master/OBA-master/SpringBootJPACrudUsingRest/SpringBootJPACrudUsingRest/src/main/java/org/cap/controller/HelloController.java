 ...
 * 
 * import org.cap.entities.Login_Details; import
 * org.cap.service.LoginDetailsService; import org.cap.entities.User; import
 * org.cap.service.IDetailsService; import
 ...
 * 
 * @Autowired private IDetailsService service; public IDetailsService
 * getService() { return service; } public void setService(IDetailsService
 * service) { this.service = service; } private int i = 0;
 * 
 * @RequestMapping("/") public ModelAndView index() { return new
 * ModelAndView("index",new HashMap<>()); }
 * 
